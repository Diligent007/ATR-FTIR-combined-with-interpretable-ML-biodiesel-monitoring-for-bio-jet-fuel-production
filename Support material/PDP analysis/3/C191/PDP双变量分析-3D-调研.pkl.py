...
# 加载输入特征数据
inputs_df = pd.read_excel('C191-Inputs.xlsx')
...
# 设置坐标轴标签，加粗并指定字体大小
ax.set_xlabel('811', fontsize=12, fontweight='bold')
ax.set_ylabel('1020', fontsize=12, fontweight='bold')
