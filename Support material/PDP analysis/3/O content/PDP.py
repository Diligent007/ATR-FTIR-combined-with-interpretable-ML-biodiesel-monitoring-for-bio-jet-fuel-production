...
# 加载输入特征数据
inputs_df = pd.read_excel('O content-Inputs.xlsx')
...
N_index = 7  # 第9列，基于0开始的索引
VM_index = 8  # 第10列，基于0开始的索引
...
# 设置坐标轴标签，加粗并指定字体大小
ax.set_xlabel('3318', fontsize=12, fontweight='bold')
ax.set_ylabel('1363', fontsize=12, fontweight='bold')
