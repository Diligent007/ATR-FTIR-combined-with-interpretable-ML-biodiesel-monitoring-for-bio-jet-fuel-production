...
from lightgbm import LGBMRegressor  # 替换为LightGBM
...
x_data = pd.read_excel("C192-Inputs.xlsx")
y_data = pd.read_excel("C192-Outputs.xlsx")
x_c = x_data.columns
...
# LightGBM模型优化
results = []
LGBM_optimal_params = BayesSearchCV(LGBMRegressor(), LGBM_param_space, n_iter=50, random_state=42, n_jobs=-1, cv=5,
                                    scoring="neg_root_mean_squared_error")
